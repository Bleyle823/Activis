  ...
  return (
    <div className="border-2 min-h-[300px] sm:py-4 max-w-[250px] rounded-xl  sm:rounded-md ">
      ...
      <div className="px-5 py-3 sm:py-0  sm:-mt-4">
        <h1 className="text-[30px] font-bold font-mono">Climate Change</h1>
  ...
  return (
    <div className="border-2 min-h-[430px] sm:py-4 my-10 rounded-xl  max-w-[350px]  sm:rounded-md ">
      ...
      <div className="px-6 sm:-mt-4 py-4 sm:py-0">
        <h1 className="text-[30px] font-bold font-mono">End Violence Against Women</h1>
        <div className="flex justify-between w-full mb-4 mt-2 px-3">
          <div className="flex items-center  text-xl">
            <svg
              width="20"
        ...
        <div className="flex justify-between font-mono">
          <button className="border-[1px]  rounded-2xl flex px-[.6em] py-[.7em]  items-center ">
            <h1 className="font-bold">View Campaign</h1>
            <div className=" ml-2">
              <svg
                width="16"
                height="20"
